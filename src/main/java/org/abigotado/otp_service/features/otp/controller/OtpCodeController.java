...
public class OtpCodeController {
    ...
    public ResponseEntity<OtpCodeResponse> generate(@RequestBody(required = false) OtpCodeRequest request,
                                                    @AuthenticationPrincipal User user) {
        var response = otpService.generateCode(user.getId(), request != null ? request.operationId() : null);
